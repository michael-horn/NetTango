...
]  ;; keep track of how much grass there is
...
to setup
  ...
  create-sheep start-sheep  ;; create the sheep, then initialize their variables
  [
    set color white
  ...
  create-wolves start-wolves  ;; create the wolves, then initialize their variables
  [
    set color black
    set size 1.5  ;; easier to see
